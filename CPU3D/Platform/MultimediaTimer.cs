...
namespace CPU3D.Platform.Windows
{
    public class MultimediaTimer : IDisposable
    {
        ...
        public MultimediaTimer() : this(10)
        {
        }

        public MultimediaTimer(int MilliSeconds) : this(MilliSeconds, 5)
        {

        }

        public MultimediaTimer(int MilliSeconds, int Resolution)
        {
        ...
        public object ElapseLock = new object();
